...
exports.read = {
    ...
    list: function(req, res) {
        var params = req.body;
        exports.model.Catalog.findById(req.params.id, function(err, record) {
            if (!err) {
    ...
    tree: function(req, res) {
        ...
        var criteria = req.query.node !== 'root' ? 
                                            {parentId: req.query.node} : 
                                            {parentId: null/*{$exists: false}*/ }; // Get by Parent
        
        exports.model.Catalog.find(criteria, false, {
                                            //skip:0, // Starting Row
                                            //limit:10, // Ending Row
                                            sort:{
                                                index: 1 //Sort by Date Added ASC
                                            }
...
exports.update = function(req, res) {
    ...
    exports.model.Catalog.findById(id, function(err, record) {
        if (!err) {
...
exports.destroy = {
    ...
    node : function(req, res) {
        ...
        exports.model.Catalog.findOne({"_id": params._id}, function(err, Catalog) {
    ...
    cascade : function(req,res){

        var Catalog = exports.model.Catalog;

        Catalog.findById(req.params.id, function(err, record) {
...
exports.clone = {
    node : function(req, res) {
        ...
        function cloneDocument ( docId , callback, firstrun ) {
            Catalog.findById(docId, function(err, currDoc ){
                if (!err) {
                    var status = false;
                    delete currDoc.lft;
                    delete currDoc.rgt;
        ...
        // Main (Load catalog)
        Catalog.findById(req.params.id, function(err, mainNode) {
            if (!err) {
